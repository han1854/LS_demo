...
router.get("/:id/refund/status", 
    authMiddleware, 
    transactionController.getRefundStatus
);

// Invoices & Receipts
router.get("/:id/invoice", 
    authMiddleware, 
    transactionController.generateInvoice
);
...
router.get("/course/:courseId/revenue", 
    authMiddleware, 
    checkRole(['instructor', 'admin']), 
...
router.get("/instructor/payout-history", 
    authMiddleware, 
    checkRole(['instructor']), 
...
// Revenue Sharing
router.post("/revenue-share/calculate", 
    authMiddleware, 
    checkRole(['admin']), 
...
router.post("/subscription/create", 
    authMiddleware, 
    transactionController.createSubscription
);

router.put("/subscription/:id", 
    authMiddleware, 
    transactionController.updateSubscription
);

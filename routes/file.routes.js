...
// File Access Routes
router.get('/lesson/:lessonId', authMiddleware, fileController.getLessonFiles);

router.get('/assignment/:assignmentId', authMiddleware, fileController.getAssignmentFiles);

router.get('/submission/:submissionId', authMiddleware, fileController.getSubmissionFiles);

// File Download Routes
router.get('/:id/download', authMiddleware, fileController.downloadFile);

router.post('/bulk-download', authMiddleware, fileController.downloadMultipleFiles);
...
router.get('/:id/permissions', authMiddleware, fileController.getFilePermissions);

// File Preview
router.get('/:id/preview', authMiddleware, fileController.previewFile);

router.get('/:id/thumbnail', authMiddleware, fileController.getFileThumbnail);
...
// Virus Scanning
router.post('/:id/scan', authMiddleware, checkRole(['admin']), fileController.scanFile);

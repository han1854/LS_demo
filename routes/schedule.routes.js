...
router.get("/course/:courseId", 
    authMiddleware, 
    scheduleController.getCourseSchedule
);
...
router.put("/:id/attendance/:studentId", 
    authMiddleware, 
    checkRole(['instructor']), 
...
router.post("/:id/reminder", 
    authMiddleware, 
    scheduleController.setSessionReminder
);

router.post("/batch/reminder", 
    authMiddleware, 
    checkRole(['instructor']), 
...
router.post("/sync/calendar", 
    authMiddleware, 
    scheduleController.syncWithCalendar
);

router.get("/export/calendar", 
    authMiddleware, 
    scheduleController.exportToCalendar
);

...
router.get(
  ...
  authMiddleware,
  checkRole(['instructor']),
  lessonController.getCompletionStats,
);
...
router.get(
  ...
  authMiddleware,
  checkRole(['instructor']),
  lessonController.previewLesson,
);
router.post(
  '/:id/preview',
  authMiddleware,
  checkRole(['instructor']),
  lessonController.generatePreview,
);
...
router.get(
  ...
  lessonController.getEngagementAnalytics,
);
router.get(
  '/analytics/time-spent',
  authMiddleware,
  checkRole(['admin', 'instructor']),
  lessonController.getTimeSpentAnalytics,
);

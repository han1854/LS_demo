...
router.get('/:id/download', authMiddleware, certificateController.downloadCertificate);

// Certificate Verification
router.get('/verify/:certNumber', certificateController.verifyCertificate);

router.get('/verify/:certNumber/details', certificateController.getCertificateVerificationDetails);
...
// Bulk Operations
router.post('/bulk/verify', certificateController.bulkVerifyCertificates);

...
router.get("/course/:courseId/summary", 
    ratingController.getCourseSummary
);
...
router.put("/:id/reply", 
    authMiddleware, 
    checkRole(['instructor']), 
    ratingController.updateReply
);
router.delete("/:id/reply", 
    authMiddleware, 
    checkRole(['instructor']), 
...
router.get("/reports", 
    authMiddleware, 
    checkRole(['admin']), 
    ratingController.getRatingReports
);
...
router.get("/instructor/:instructorId/analytics", 
    authMiddleware, 
    checkRole(['instructor', 'admin']), 
...
// Rating Filters
router.get("/course/:courseId/filter", 
    ratingController.filterRatings
);

// Helpful Votes
router.post("/:id/helpful", 
    authMiddleware, 
    ratingController.markAsHelpful
);
router.delete("/:id/helpful", 
    authMiddleware, 
    ratingController.removeHelpfulMark
);

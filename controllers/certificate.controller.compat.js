...
const compat = {
  ...
  generateBatchCertificates:
    base.generateBatchCertificates || noopNotImpl('generateBatchCertificates'),
  ...
  getCertificateVerificationDetails:
    base.getCertificateVerificationDetails || noopNotImpl('getCertificateVerificationDetails'),

  // Templates
  getCertificateTemplates: base.getCertificateTemplates || noopNotImpl('getCertificateTemplates'),
  createCertificateTemplate:
    base.createCertificateTemplate || noopNotImpl('createCertificateTemplate'),
  updateCertificateTemplate:
    base.updateCertificateTemplate || noopNotImpl('updateCertificateTemplate'),

  // Analytics
  getCertificateAnalytics: base.getCertificateAnalytics || noopNotImpl('getCertificateAnalytics'),
  getCourseCertificateStats:
    base.getCourseCertificateStats || noopNotImpl('getCourseCertificateStats'),

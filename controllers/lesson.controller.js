...
exports.create = async (req, res) => {
  try {
    const { CourseID, Title, Description, VideoURL, Content, Duration, OrderIndex } = req.body;
...
exports.findAll = async (req, res) => {
  try {
    const { courseId, status, search, sort_by, order = 'asc', page = 1, limit = 10 } = req.query;
